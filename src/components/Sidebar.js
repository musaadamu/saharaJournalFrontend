...
//             </li>
//             <li>
//               <Link to="/journals" onClick={closeSidebar}>
//                 View Journals
//               </Link>
//             </li>
//             <li>
//               <Link to="/journals/uploads" onClick={closeSidebar}>
//                 Upload Journal
//               </Link>
//             </li>
//             <li>
//               <Link to="/submission" onClick={closeSidebar}>
//                 Submit Journal
//               </Link>
//             </li>
//             <li>
//               <Link to="/updateprofile" onClick={closeSidebar}>
//                 Update Profile
//               </Link>
//             </li>
//             <li>
//               <Link to="/manage-journals" onClick={closeSidebar}>
//                 Manage Journals
//               </Link>
//             </li>
//             <li>
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        setUserJournals(journalsResponse.data || []);
      } catch (error) {
